...
__device__ __host__ VoxelRGBW::VoxelRGBW(const Vector3<unsigned char> &rgb,
...
__device__ __host__ VoxelSEGM::VoxelSEGM(float probability)
    : probability(probability) {}

__device__ __host__ VoxelSpatialTSDF::VoxelSpatialTSDF(){};
__device__ __host__
VoxelSpatialTSDF::VoxelSpatialTSDF(const Vector3<float> &position)
    : VoxelSpatialTSDF(position, 1.) {}
__device__ __host__
VoxelSpatialTSDF::VoxelSpatialTSDF(const Vector3<float> &position, float tsdf)
